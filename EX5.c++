...
//fonction de recherche avec 3 parametres :




/*bool recherche(set <int> :: iterator debut,set <int> :: iterator fin,int element){
...
cout << "1:Se trouve   0:se trouve pas" <<endl;
...
cout << "Recherche Linux dans vecteur : " << recherche(v1.begin(),v1.end(),"linux") << endl;
cout << "Recherche html dans vecteur : " << recherche(v1.begin(),v1.end(),"html") << endl;
